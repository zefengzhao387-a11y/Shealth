...
export function BottomNav({ forceHide = false }: { forceHide?: boolean }) {
  ...
  return (
    ...
    >
      <div className="mx-3 mb-[calc(env(safe-area-inset-bottom,0px)+0.75rem)] rounded-3xl px-2 py-2.5 bg-card/94 backdrop-blur-xl border border-border/60 shadow-[0_12px_34px_oklch(0.62_0.13_358_/_0.12)]">
